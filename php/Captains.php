...
$sql = "SELECT captains.captainName, captains.rank, ships.shipname, ships.shiptype, companies.companyname, nations.nationality, voyages.startDate FROM captains  ";
...
$colnames = array("Captain", "CaptainRank", "ShipName", "ShipType", "Company", "Nationality", 'startDate');
