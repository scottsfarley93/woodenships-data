...
$sql = "SELECT distinct voyages.toPlace, ports.modernName, ports.latitude, ports.longitude FROM voyages  ";
$sql .= " INNER JOIN ports on voyages.toPlace = ports.portName WHERE ";
