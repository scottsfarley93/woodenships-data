...
$sql = "SELECT ships.shipname, ships.shiptype, captains.captainName, companies.companyname, nations.nationality, voyages.fromPlace, voyages.toPlace, voyages.startDate  FROM voyages ";
...
$colnames = array("ShipName", "ShipType", "Captain", "Company", "Nationality", "FromPlace", 'ToPlace', 'StartDate');
